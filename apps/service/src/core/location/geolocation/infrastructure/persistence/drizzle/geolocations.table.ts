...
import {
    GeolocationTarget,
    geolocationTargets,
} from 'core/location/geolocation/domain/enum/geolocation-targets';
...
export const geolocations = p.pgTable(
    'geolocations',
    {
        ...
        targetType: p
            .text('target_type', {
                enum: Object.values(geolocationTargets) as [string, ...string[]],
            })
...
export const geolocationsRelations = relations(geolocations, () => ({}));
