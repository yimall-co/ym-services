...
import { Role } from 'core/iam/role/domain/role';
import { RoleName } from 'core/iam/role/domain/value-object/role-name';
import { RoleCodeName } from 'core/iam/role/domain/value-object/role-code-name';
import { RoleDescription } from 'core/iam/role/domain/value-object/role-description';
import { PermissionId } from 'core/iam/shared/domain/permission-id';
