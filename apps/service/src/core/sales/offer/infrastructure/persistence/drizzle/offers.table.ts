...
import { OfferTypes, offerTypes } from 'core/sales/offer/domain/enum/offer-types';
import { SchedulingTypes, schedulingTypes } from 'core/sales/offer/domain/enum/scheduling-types';
