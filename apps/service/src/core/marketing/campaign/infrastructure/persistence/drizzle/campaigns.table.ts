...
import { campaignTypes, CampaignTypes } from 'core/marketing/campaign/domain/enum/campaign-types';
import { campaignStatuses, CampaignStatuses } from 'core/marketing/campaign/domain/enum/campaign-statuses';
