...
import { users } from 'core/iam/user/infrastructure/persistence/drizzle/users.table';
import { categories } from 'core/sales/category/infrastructure/persistence/drizzle/categories.table';
