...
import { CreateSegmentCommand } from './create-segment.command';

export class CreateSegmentCommandHandler implements CommandHandler<CreateSegmentCommand, CreateSegmentDto> {
